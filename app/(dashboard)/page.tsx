          ...
          <CardContent>
            <div className="space-y-4">
              <div className="flex items-start gap-3">
                <div className="mt-0.5 h-4 w-4 rounded-full border-primary" />
              ...
              <div className="flex items-start gap-3">
                <div className="mt-0.5 h-4 w-4 rounded-full border-gray-600" />
                <div className="flex-1">
                  <p className="text-sm font-medium">Prepare for 1:1 with Sarah</p>
                  <p className="text-muted-foreground">Due Wed, 18 Dec</p>
                </div>
              </div>
              <div className="flex items-start gap-3">
                <div className="mt-0.5 h-4 w-4 rounded-full border-gray-600" />
                <div className="flex-1">
                  ...
                  <p className="text-muted-foreground">Due Thu, 19 Dec</p>
                </div>
              </div>
            </div>
          </CardContent>
          ...
          <CardContent>
            <div className="space-y-4">
              <div className="flex items-center gap-3">
                <div className="flex h-10 w-10 items-center justify-center rounded-full bg-primary-dark-900 text-primary-dark-400">
                  <span className="text-sm font-semibold">SM</span>
                </div>
                <div className="flex-1">
                  <p className="text-sm font-medium">Sarah Miller</p>
                  <p className="text-muted-foreground">Wed, 18 Dec at 2:00 PM</p>
                </div>
              </div>
              <div className="flex items-center gap-3">
                <div className="flex h-10 w-10 items-center justify-center rounded-full bg-primary-dark-900 text-primary-dark-400">
                ...
                <div className="flex-1">
                  ...
                  <p className="text-muted-foreground">Thu, 19 Dec at 10:00 AM</p>
                </div>
              </div>
              <div className="flex items-center gap-3">
                <div className="flex h-10 w-10 items-center justify-center rounded-full bg-primary-dark-900 text-primary-dark-400">
                ...
                <div className="flex-1">
                  ...
                  <p className="text-muted-foreground">Fri, 20 Dec at 3:30 PM</p>
                </div>
              </div>
            </div>
          </CardContent>
          ...
          <div className="space-y-4">
            <div className="flex gap-4">
              ...
              <div className="flex-1 pb-4">
                ...
                <p className="text-muted-foreground">Code review for PR #234 - 2 hours ago</p>
              </div>
            </div>
            <div className="flex gap-4">
              <div className="flex flex-col items-center">
              ...
              <div className="flex-1 pb-4">
                ...
                <p className="text-muted-foreground">1:1 with Mike Chen - 5 hours ago</p>
              </div>
            </div>
            <div className="flex gap-4">
              <div className="flex flex-col items-center">
              ...
              <div className="flex-1">
                ...
                <p className="text-muted-foreground">Sprint 23 finished with 95% completion - Yesterday</p>
              </div>
            </div>
          </div>
        </CardContent>
